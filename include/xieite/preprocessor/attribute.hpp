...
#include "../preprocessor/has_attribute.hpp"
...
#elif XIEITE_COMPILER_TYPE_GCC || XIEITE_HAS_ATTRIBUTE(__aligned__)
...
#if XIEITE_LANGUAGE_STANDARD_CPP_2017 || XIEITE_COMPILER_VERSION_LEAST(GCC, 8, 0, 0) && XIEITE_LANGUAGE_STANDARD_CPP_2011
#	define XIEITE_ATTRIBUTE_FALLTHROUGH() [[fallthrough]]
#elif XIEITE_COMPILER_VERSION_LEAST(GCC, 7, 0, 0) && (!XIEITE_COMPILER_TYPE_LCC || ((XIEITE_COMPILER_VERSION_MAJOR_LCC == 124) && (XIEITE_COMPILER_VERSION_MINOR_LCC >= 12)) || ((XIEITE_COMPILER_VERSION_MAJOR_LCC == 125) && (XIEITE_COMPILER_VERSION_MINOR_LCC >= 5)) || (XIEITE_COMPILER_VERSION_MAJOR_LCC >= 126))
#	define XIEITE_ATTRIBUTE_FALLTHROUGH() __attribute__((__fallthrough__))
#elif XIEITE_COMPILER_TYPE_CLANG && XIEITE_LANGUAGE_STANDARD_CPP_2011
...
#elif XIEITE_LANGUAGE_STANDARD_CPP_2011
