...
export namespace xieite::containers {
    ...
    struct FixedString {
        constexpr static std::size_t size = characters;
        ...
        constexpr FixedString(Range&& data) noexcept(xieite::concepts::NoThrowOperableRange<Range>)
        // : data(xieite::containers::makeArray<Character, characters>(std::forward<decltype(data)>(data)))
        {
        }
