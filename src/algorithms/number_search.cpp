...
export namespace xieite::algorithms {
    ...
    [[nodiscard]] constexpr Arithmetic numberSearch(Functor&& selector, Arithmetic minimum, std::type_identity_t<Arithmetic> maximum) noexcept(xieite::concepts::NoThrowInvocable<Functor, bool(Arithmetic)>) {
        while (true) {
    ...
    template <xieite::concepts::Arithmetic Arithmetic, xieite::concepts::Invocable<bool(Arithmetic)> Functor>
    [[nodiscard]] constexpr Arithmetic numberSearch(Functor&& selector) noexcept(xieite::concepts::NoThrowInvocable<Functor, bool(Arithmetic)>) {
