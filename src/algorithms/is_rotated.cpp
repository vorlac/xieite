...
export namespace xieite::algorithms {
    ...
    [[nodiscard]] constexpr bool isRotated(Range1&& range1, Range2&& range2, Functor&& comparator = Functor()) noexcept(xieite::concepts::NoThrowInvocable<Functor, bool(std::ranges::range_reference_t<Range1>, std::ranges::range_reference_t<Range2>)> && xieite::concepts::NoThrowOperableRange<Range1> && xieite::concepts::NoThrowOperableRange<Range2>) {
