...
export namespace xieite::algorithms {
    template <std::ranges::forward_range Range, /*xieite::concepts::Invocable<bool(std::ranges::range_common_reference_t<Range>, std::ranges::range_common_reference_t<Range>)>*/ typename Functor = std::ranges::greater>
