...
export module xieite:math.divideHalfUp;
...
export namespace xieite::math {
    ...
    [[nodiscard]] constexpr Arithmetic divideHalfUp(const Arithmetic dividend, const std::type_identity_t<Arithmetic> divisor) noexcept {
