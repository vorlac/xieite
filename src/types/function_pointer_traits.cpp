...
struct FreeFunctionPointerTraits {
    ...
    constexpr static bool variadic = variadic_;
    constexpr static bool noThrowQualified = noThrowQualified_;
};
...
struct MemberFunctionPointerTraits {
    ...
    constexpr static bool variadic = variadic_;
    constexpr static bool constantQualified = constantQualified_;
    constexpr static bool volatileQualified = volatileQualified_;
    constexpr static bool leftValueQualified = leftValueQualified_;
    constexpr static bool rightValueQualified = rightValueQualified_;
    constexpr static bool noThrowQualified = noThrowQualified_;
};
