...
export namespace xieite::geometry {
    ...
    [[nodiscard]] constexpr std::type_identity_t<xieite::geometry::Point<Arithmetic>> scale(const xieite::geometry::Point<Arithmetic> point, const std::conditional_t<std::floating_point<Arithmetic>, Arithmetic, double> scale, const xieite::geometry::Point<Arithmetic> origin = xieite::geometry::Point<Arithmetic>()) noexcept {
