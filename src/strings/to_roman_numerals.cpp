...
export namespace xieite::strings {
    ...
    [[nodiscard]] constexpr std::string toRomanNumerals(const Integral value) noexcept {
        constexpr static std::array<std::string_view, 10> ones = {
            "",
            "I",
            "II",
            "III",
        ...
        constexpr static std::array<std::string_view, 10> tens = {
            "",
            "X",
            "XX",
            "XXX",
        ...
        constexpr static std::array<std::string_view, 10> hundreds = {
            "",
            "C",
            "CC",
            "CCC",
