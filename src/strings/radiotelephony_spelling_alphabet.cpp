...
export module xieite:strings.radiotelephonySpellingAlphabet;

export namespace xieite::strings {
    constexpr std::array<std::string_view, (1 << std::numeric_limits<unsigned char>::digits)> radiotelephonySpellingAlphabet() {
        return [] {
            std::array<std::string_view, (1 << std::numeric_limits<unsigned char>::digits)> result;
